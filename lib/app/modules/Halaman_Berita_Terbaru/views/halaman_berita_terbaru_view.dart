...
class HalamanBeritaTerbaruView extends StatefulWidget {
  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HalamanBeritaTerbaruView> {
              ...
              children: <Widget>[
                ...
                StreamBuilder<DateTime>(
                  stream: Stream.periodic(Duration(seconds: 1),
                      (_) => DateTime.now()), // Update every second
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      return CircularProgressIndicator(); // Wait for the first data
                    }
                ...
                SizedBox(height: 10), // Ensure space between UI and list
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<DocumentSnapshot> filteredDocs =
                      ...
                      String title = (doc['judul_artikel'] ?? '').toLowerCase();
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildArticleCard(
                            articleData); // Return the card widget
                      },
                      shrinkWrap: true, // Prevent scrolling issues in ListView
                      physics:
  ...
  Widget _buildArticleCard(DocumentSnapshot articleData) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        width: double
            .infinity, // Set lebar agar mengisi seluruh layar secara vertikal
        height: 290, // Sesuaikan tinggi kartu sesuai kebutuhan
        margin: EdgeInsets.only(bottom: 9), // Jarak antar card secara vertikal
        child: Card(
