...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ReadAremadayView(),
    );
  }
}

class ReadAremadayView extends StatefulWidget {
  @override
  _ReadBeritaTerbaruViewState createState() => _ReadBeritaTerbaruViewState();
}

class _ReadBeritaTerbaruViewState extends State<ReadAremadayView> {
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/gambar2.jpeg', // Ganti dengan path gambar Anda
                  height: 300,
...
// Widget untuk menampilkan berita
