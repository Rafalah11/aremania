...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AremaReadAremaputriView(),
    );
  }
}

class AremaReadAremaputriView extends StatefulWidget {
  @override
  _ReadBeritaTerbaruViewState createState() => _ReadBeritaTerbaruViewState();
}

class _ReadBeritaTerbaruViewState extends State<AremaReadAremaputriView> {
