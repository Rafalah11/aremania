...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ReadAremaniaView(),
    );
  }
}

class ReadAremaniaView extends StatefulWidget {
  @override
  _ReadAremaniaViewState createState() => _ReadAremaniaViewState();
}

class _ReadAremaniaViewState extends State<ReadAremaniaView> {
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/gambar3.jpg', // Ganti dengan path gambar Anda
                  height: 300,
