...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: NgalamInfopentingView(),
    );
  }
}

class NgalamInfopentingView extends StatefulWidget {
  @override
  _NewsPageState createState() => _NewsPageState();
}

class _NewsPageState extends State<NgalamInfopentingView> {
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: _selectedMenuIndex == 4 && index == 4
                                ? Colors.blue
                                : Colors.grey[300],
  ...
  Widget _buildFeaturedNewsCard() {
    return GestureDetector(
      onTap: () {
        ...
        Get.to(() => NgalamReadInfoPentingView());
      },
      child: Stack(
        children: [
          // Background image
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Info Penting Rekam Jejak Malut United, Sama Persis Dengan Pencapaian Arema',
                  style: TextStyle(
                    color: Colors.black,
          ...
          GestureDetector(
            ...
            onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        NgalamReadInfoPentingView()), // Ganti dengan halaman yang diinginkan
              );
            },
            child: Container(
              width: double.infinity,
