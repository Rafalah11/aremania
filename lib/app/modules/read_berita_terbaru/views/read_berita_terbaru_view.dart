...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ReadBeritaTerbaruView(),
    );
  }
}

class ReadBeritaTerbaruView extends StatefulWidget {
  @override
  _ReadBeritaTerbaruViewState createState() => _ReadBeritaTerbaruViewState();
}

class _ReadBeritaTerbaruViewState extends State<ReadBeritaTerbaruView> {
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Image.asset(
                  'assets/gambar4.jpg', // Ganti dengan path gambar Anda
                  height: 300,
