...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: NgalamReadMalangankulinerView(),
    );
  }
}

class NgalamReadMalangankulinerView extends StatefulWidget {
  @override
  _ReadBeritaTerbaruViewState createState() => _ReadBeritaTerbaruViewState();
}

class _ReadBeritaTerbaruViewState extends State<NgalamReadMalangankulinerView> {
