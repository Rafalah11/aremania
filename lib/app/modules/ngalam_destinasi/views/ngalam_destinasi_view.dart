...
import 'package:myapp/app/modules/ngalam_destinasi/controllers/ngalam_destinasi_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: NgalamDestinasiView(),
    );
  }
}

class NgalamDestinasiView extends StatefulWidget {
  @override
  _NgalamDestinasiViewState createState() => _NgalamDestinasiViewState();
}

class _NgalamDestinasiViewState extends State<NgalamDestinasiView> {
  // bool _isBookmarked = false;
  Map<String, bool> bookmarkStatus = {};
  int _selectedIndex = 1;
  int _selectedMenuIndex = 1;
  final NgalamDestinasiController _controller =
      Get.put(NgalamDestinasiController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // StreamBuilder untuk mendapatkan gambar artikel destinasi
          // Ambil ID Artikel Terbaru
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                .collection('Informasi')
                .orderBy('tanggal_upload',
                    descending: true) // Mengambil dokumen destinasi
                .snapshots(),
            builder: (context, snapshot) {
              ...
              // Ambil detail artikel berdasarkan id_artikel destinasi
