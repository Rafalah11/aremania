...
class _NewsPageState extends State<NgalamDestinasiView> {
  ...
  Widget _buildFeaturedNewsCard() {
    return GestureDetector(
      onTap: () {
        ...
        Get.to(() => NgalamReadDestinasiView());
      },
      child: Stack(
        children: [
          // Background image
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Destinasi Rekam Jejak Malut United, Sama Persis Dengan Pencapaian Arema',
                  style: TextStyle(
                    color: Colors.black,
