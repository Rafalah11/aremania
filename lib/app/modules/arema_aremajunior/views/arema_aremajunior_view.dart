...
import 'package:myapp/app/modules/arema_aremajunior/controllers/arema_aremajunior_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AremaAremajuniorView(),
    );
  }
}

class AremaAremajuniorView extends StatefulWidget {
  @override
  _NewsPageState createState() => _NewsPageState();
}

class _NewsPageState extends State<AremaAremajuniorView> {
