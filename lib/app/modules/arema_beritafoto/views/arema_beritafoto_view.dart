...
import 'package:myapp/app/modules/arema_beritafoto/controllers/arema_beritafoto_controller.dart';
import 'package:myapp/app/modules/arema_editorial/views/arema_editorial_view.dart';
import 'package:myapp/app/modules/arema_read_beritafoto/views/arema_read_beritafoto_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AremaBeritafotoView(),
    );
  }
}

class AremaBeritafotoView extends StatefulWidget {
  @override
  _NewsPageState createState() => _NewsPageState();
}

class _NewsPageState extends State<AremaBeritafotoView> {
  // bool _isBookmarked = false;
  int _selectedIndex = 1;
  int _selectedMenuIndex = 2; // Set to Arema Junior by default
