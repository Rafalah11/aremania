...
import 'package:myapp/app/modules/arema_aremaputri/controllers/arema_aremaputri_controller.dart';
...
import 'package:myapp/app/modules/arema_read_aremaputri/views/arema_read_aremaputri_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AremaAremaputriView(),
    );
  }
}

class AremaAremaputriView extends StatefulWidget {
  @override
  _NewsPageState createState() => _NewsPageState();
}

class _NewsPageState extends State<AremaAremaputriView> {
  // bool _isBookmarked = false;
  int _selectedIndex = 1;
  int _selectedMenuIndex = 1; // Set to Arema Junior by default
  ...
  void _onMenuTapped(int index) {
    ...
    if (index != 3) {
      _selectedMenuIndex = 3; // Reset to Arema Junior as the only selected menu
    } else {
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .where('sub_kategori', isEqualTo: 'arema_putri')
